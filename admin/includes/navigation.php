 ...
 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><?php echo $role; ?></a>
            </div>
            <!-- Top Menu Items -->
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="posts.php?source=viewPost">View Posts</a>
                            </li>
                            <li>
                                <a href="posts.php?source=addPost">Add New Posts</a>
                            </li>
                    ...
                    <li>
                        <a href="comment.php?view"><i class="fa fa-fw fa-comment"></i> Comments </a>
                    </li>
                    ...
                    <li>
                        <a style="margin-top: 128px;" href="?logout"><i class="fa fa-fw fa-power-off"></i> Logout</a>
                    </li>
